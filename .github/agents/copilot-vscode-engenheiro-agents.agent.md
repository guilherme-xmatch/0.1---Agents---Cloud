...
agents: ['Copilot VS Code Arquiteto de Configuracoes', 'Copilot VS Code Curador de Evidencias', 'Copilot VS Code Governador de MCP', 'Copilot VS Code Orquestrador de Subagents', 'Copilot VS Code Auditor de Setup']
...
7. valide naming, frontmatter, links e blast radius
